...
type Health = { trading: { environment: "uat" | "prod"; api_rail_possible: boolean; trading_enabled_setting?: boolean; trading_enabled_env?: boolean }; owner_auth: string; owner_passphrase_source?: "db" | "env" | "none"; broker: { status: string; token_status?: string | null }; risk_rules?: { whitelist?: string[] }; counts: { tickets: number } };
